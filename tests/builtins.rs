use aurora_shell::{builtins, env::Env, value::Value};
...
fn builtin_map_reduce_direct() {
    ...
    let f = Value::Lambda(aurora_shell::value::Lambda {
        params: vec!["x".into()],
        body: Box::new(aurora_shell::ast::Expr::Binary {
            left: Box::new(aurora_shell::ast::Expr::Ident("x".into())),
            op: aurora_shell::ast::BinOp::Mul,
            right: Box::new(aurora_shell::ast::Expr::LitInt(2)),
        }),
    });
    ...
    let add = Value::Lambda(aurora_shell::value::Lambda {
        params: vec!["a".into(), "b".into()],
        body: Box::new(aurora_shell::ast::Expr::Binary {
            left: Box::new(aurora_shell::ast::Expr::Ident("a".into())),
            op: aurora_shell::ast::BinOp::Add,
            right: Box::new(aurora_shell::ast::Expr::Ident("b".into())),
        }),
    });
