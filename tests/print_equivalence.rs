...
fn print_equivalence() {
    ...
    let pretty_a = aurora_shell::value::pretty::display_inline(
        &a,
        &aurora_shell::value::pretty::Theme::default(),
    );
    let pretty_b = aurora_shell::value::pretty::display_inline(
        &b,
        &aurora_shell::value::pretty::Theme::default(),
    );
    let pretty_c = aurora_shell::value::pretty::display_inline(
        &c,
        &aurora_shell::value::pretty::Theme::default(),
    );
