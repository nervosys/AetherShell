...
pub static SIGNATURES: &[Signature] = &[
    ...
    // Plan item 1b, first tranche of parameter-taking builtins: pure data
    // functions from the discarded-args list, each body read for its
    // parameters, each example measured before it was written.
    Signature {
        name: "crypto_hex_encode",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: Some(Ty::Str),
        params: &[],
        returns: "String",
        doc: "The bytes of a string as lowercase hex.",
        examples: &[
            (r#"crypto_hex_encode("hi")"#, r#"6869"#),
            (r#""hi" | crypto_hex_encode()"#, r#"6869"#),
        ],
    },
    Signature {
        name: "crypto_hex_decode",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: Some(Ty::Str),
        params: &[],
        returns: "String",
        doc: "Decode hex digit pairs to a string. Odd length or a non-hex digit is refused.",
        examples: &[
            (r#"crypto_hex_decode("6869")"#, r#"hi"#),
        ],
    },
    Signature {
        name: "digest",
        ...
        params: &[],
        returns: "Record",
        doc: "A constant-size summary of a value: kind, size, element shape, a two-element sample and its token cost.",
        examples: &[
            (r#"digest([1, 2, 3]).len"#, r#"3"#),
        ],
    },
    Signature {
        name: "json_stringify",
        ...
        params: &[],
        returns: "String",
        doc: "A value as compact JSON.",
        examples: &[
            (r#"json_stringify({a: 1})"#, r#"{"a":1}"#),
        ],
    },
    Signature {
        name: "type_name",
        ...
        params: &[],
        returns: "String",
        doc: "A detailed type description, with element and field types.",
        examples: &[
            (r#"type_name([1, 2])"#, r#"Array<Int>"#),
        ],
    },
    Signature {
        name: "type_schema",
        ...
        params: &[],
        returns: "Record",
        doc: "A JSON Schema describing a value's structure.",
        examples: &[
            (r#"type_schema({a: 1}).type"#, r#"object"#),
        ],
    },
    Signature {
        name: "is_error",
        ...
        params: &[],
        returns: "Bool",
        doc: "Whether a value is an Error.",
        examples: &[
            (r#"is_error(42)"#, r#"false"#),
        ],
    },
    Signature {
        name: "canonical",
        ...
        params: &[],
        returns: "String",
        doc: "Canonical JSON: sorted keys and shortest round-trip floats, byte-identical for equal values on every OS.",
        examples: &[
            (r#"canonical({b: 1, a: 2})"#, r#"{"a":2,"b":1}"#),
        ],
    },
    Signature {
        name: "aecon",
        ...
        params: &[],
        returns: "String",
        doc: "A value as compact AECON text, which states the keys of a homogeneous record array once.",
        examples: &[
            (r#"typeof(aecon([{a: 1}, {a: 2}]))"#, r#"String"#),
        ],
    },
    Signature {
        name: "aecon_decode",
        ...
        params: &[],
        returns: "Array",
        doc: "Parse tabular AECON text back into an array of records; the inverse of aecon.",
        examples: &[
            (r#"aecon_decode(aecon([{a: 1}, {a: 2}])) | len"#, r#"2"#),
        ],
    },
    Signature {
        name: "tokens",
        ...
        params: &[],
        returns: "Int",
        doc: "An estimate of the tokens in a value's rendered form.",
        examples: &[
            (r#"tokens("hello world")"#, r#"4"#),
        ],
    },
    Signature {
        name: "platform_hash",
        ...
        aliases: &[],
        subject: None,
        params: &[req("value", Ty::Any, "value to fingerprint")],
        returns: "String",
        doc: "A short hex fingerprint of a value's structure.",
        examples: &[
            (r#"typeof(platform_hash("x"))"#, r#"String"#),
        ],
    },
    Signature {
        name: "platform_normalize_output",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: None,
        params: &[req("text", Ty::Str, "text with any line endings")],
        returns: "String",
        doc: "Convert CRLF and CR line endings to LF.",
        examples: &[
            (r#"platform_normalize_output("a\r\nb") | len"#, r#"3"#),
        ],
    },
    Signature {
        name: "platform_normalize_path",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: None,
        params: &[req("path", Ty::Str, "a path with either separator")],
        returns: "String",
        doc: "Convert backslash separators to forward slashes.",
        examples: &[
            (r#"platform_normalize_path("src/main.rs")"#, r#"src/main.rs"#),
        ],
    },
    Signature {
        name: "code_language",
        ...
        aliases: &[],
        subject: None,
        params: &[req("path", Ty::Str, "a file path; only its extension is read")],
        returns: "String",
        doc: "The programming language a file's extension indicates.",
        examples: &[
            (r#"code_language("main.rs")"#, r#"rust"#),
        ],
    },
    Signature {
        name: "inspect",
        ...
        params: &[],
        returns: "Record",
        doc: "A value's type, size and contents, as a record.",
        examples: &[
            (r#"inspect([1, 2]).type"#, r#"Array"#),
        ],
    },
    Signature {
        name: "debug",
        ...
        params: &[],
        returns: "Any",
        doc: "Print a value and its type to stderr and return it unchanged, for use mid-pipeline.",
        examples: &[
            (r#"debug(42)"#, r#"42"#),
        ],
    },
    Signature {
        ...
        aliases: &[],
        subject: None,
        params: &[req("name", Ty::Str, "a category or builtin name")],
        returns: "Record",
        doc: "A category's builtins, or one builtin's full definition.",
        examples: &[
            (r#"typeof(ontology_describe("Array"))"#, r#"Record"#),
        ],
    },
    Signature {
        ...
        params: &[],
        returns: "Bool",
        doc: "Whether a runtime feature flag is enabled.",
        examples: &[
            (r#"feature_enabled("definitely_not_a_feature")"#, r#"false"#),
            (r#""definitely_not_a_feature" | has_feature()"#, r#"false"#),
        ],
    },
    Signature {
        name: "assert",
        ...
        aliases: &[],
        subject: Some(Ty::Any),
        params: &[opt("message", Ty::Str, "error message when the condition is false")],
        returns: "Bool",
        doc: "Refuse with the message unless the condition is true; true otherwise.",
        examples: &[
            (r#"assert(1 == 1)"#, r#"true"#),
            (r#"assert(true, "never shown")"#, r#"true"#),
        ],
    },
    Signature {
        name: "handle_drop",
        ...
        aliases: &[],
        subject: None,
        params: &[req("id", Ty::Str, "a handle id from handles()")],
        returns: "Bool",
        doc: "Release a result handle, reporting whether it existed.",
        examples: &[
            (r#"handle_drop("no-such-handle")"#, r#"false"#),
        ],
    },
    // 1b: builtins over in-process registries. Keys are declared Any because
    // the bodies take a String or an integer id through key_arg, which
    // refuses anything else; Ty has no union for that.
    Signature {
        name: "user_roles",
        category: None,
        subject_required: false,
        ...
        params: &[],
        returns: "Array",
        doc: "The roles assigned to a user; empty for a user with none.",
        examples: &[
            (r#"user_roles("nobody-with-this-name")"#, r#"[]"#),
        ],
    },
    Signature {
        name: "role_create",
        ...
        aliases: &["create_role"],
        subject: Some(Ty::Any),
        params: &[opt("permissions", Ty::Array, "{resource, actions} records"), opt("description", Ty::Str, "what the role is for")],
        returns: "Record",
        doc: "Create an RBAC role. A malformed permission entry is refused, never dropped.",
        examples: &[
            (r#"role_create("example-reader", [{resource: "docs", actions: ["read"]}]).status"#, r#"created"#),
            (r#"("example-reader" | role_create([{resource: "docs", actions: ["read"]}])).role"#, r#"example-reader"#),
        ],
    },
    Signature {
        name: "kg_query",
        ...
        params: &[],
        returns: "Array",
        doc: "Knowledge-graph entities and relations matching a pattern.",
        examples: &[
            (r#"kg_query("nothing-matches-this")"#, r#"[]"#),
        ],
    },
    Signature {
        name: "kg_entities",
        ...
        params: &[],
        returns: "Array",
        doc: "Every entity in the knowledge graph.",
        examples: &[
            (r#"typeof(kg_entities())"#, r#"Array"#),
        ],
    },
    Signature {
        name: "kg_relations",
        ...
        params: &[],
        returns: "Array",
        doc: "Every relation in the knowledge graph.",
        examples: &[
            (r#"typeof(kg_relations())"#, r#"Array"#),
        ],
    },
    Signature {
        name: "rag_search",
        ...
        aliases: &["search_docs"],
        subject: Some(Ty::Any),
        params: &[opt("top_k", Ty::Int, "how many chunks to use")],
        returns: "Array",
        doc: "The indexed chunks most similar to a query, with scores (top_k defaults to 5).",
        examples: &[
            (r#"typeof(rag_search("anything"))"#, r#"Array"#),
            (r#"typeof(rag_search("anything", 2))"#, r#"Array"#),
        ],
    },
    Signature {
        name: "rag_query",
        ...
        params: &[opt("top_k", Ty::Int, "how many chunks to use")],
        returns: "Record",
        doc: "Retrieve context for a query and build an answer from it (top_k defaults to 3).",
        examples: &[
            (r#"typeof(rag_query("anything"))"#, r#"Record"#),
            (r#"typeof(rag_query("anything", 1))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "rag_clear",
        ...
        params: &[],
        returns: "Int",
        doc: "Empty the RAG index, returning how many chunks it held.",
        examples: &[
            (r#"typeof(rag_clear())"#, r#"Int"#),
        ],
    },
    Signature {
        name: "job_results",
        ...
        params: &[],
        returns: "Array",
        doc: "A distributed job's results; empty for an unknown job.",
        examples: &[
            (r#"job_results("no-such-job")"#, r#"[]"#),
        ],
    },
    Signature {
        name: "job_list",
        ...
        params: &[],
        returns: "Array",
        doc: "Every distributed job, with its status.",
        examples: &[
            (r#"typeof(job_list())"#, r#"Array"#),
        ],
    },
    Signature {
        name: "cluster_nodes",
        ...
        params: &[],
        returns: "Array",
        doc: "Every node registered in the cluster.",
        examples: &[
            (r#"typeof(cluster_nodes())"#, r#"Array"#),
        ],
    },
    Signature {
        name: "cluster_status",
        ...
        params: &[],
        returns: "Record",
        doc: "Node and job counts for the cluster.",
        examples: &[
            (r#"typeof(cluster_status())"#, r#"Record"#),
        ],
    },
    Signature {
        ...
        params: &[],
        returns: "Bool",
        doc: "Remove a node, reporting whether it existed.",
        examples: &[
            (r#"cluster_remove_node("no-such-node")"#, r#"false"#),
        ],
    },
    Signature {
        name: "semantic_cache_clear",
        category: None,
        subject_required: false,
        aliases: &["cache_clear_ai"],
        subject: None,
        params: &[],
        returns: "Int",
        doc: "Empty the semantic cache, returning how many entries it held.",
        examples: &[
            (r#"typeof(semantic_cache_clear())"#, r#"Int"#),
        ],
    },
    Signature {
        name: "sso_validate",
        category: None,
        subject_required: false,
        aliases: &["validate_sso"],
        subject: Some(Ty::Any),
        params: &[],
        returns: "Record",
        doc: "Whether an SSO token is live, and whose it is.",
        examples: &[
            (r#"sso_validate("no-such-token").valid"#, r#"false"#),
        ],
    },
    Signature {
        name: "sso_logout",
        ...
        params: &[],
        returns: "Record",
        doc: "End an SSO session: status logged_out, or not_found for an unknown token.",
        examples: &[
            (r#"sso_logout("no-such-token").status"#, r#"not_found"#),
        ],
    },
    // 1b: audit, feature flags, environment, plugins, telemetry, sessions.
    // `audit_verify` waits: its no-argument form needs an active log, which a
    // test process does not have, so that form cannot be demonstrated.
    Signature {
        name: "audit_export",
        category: None,
        subject_required: false,
        aliases: &["export_audit"],
        subject: None,
        params: &[opt("format", Ty::Str, "\"json\", the only format implemented")],
        returns: "Record",
        doc: "The in-memory audit log as {format, count, entries}. Any format but json is refused rather than mislabelled.",
        examples: &[
            (r#"audit_export().format"#, r#"json"#),
            (r#"audit_export("json").format"#, r#"json"#),
        ],
    },
    Signature {
        name: "audit_query",
        ...
        aliases: &["query_audit"],
        subject: None,
        params: &[opt("filter", Ty::Record, "field values an entry must match")],
        returns: "Array",
        doc: "Audit log entries, optionally only those matching a filter record.",
        examples: &[
            (r#"typeof(audit_query())"#, r#"Array"#),
            (r#"typeof(audit_query({user: "nobody"}))"#, r#"Array"#),
        ],
    },
    Signature {
        name: "feature_enable",
        ...
        params: &[],
        returns: "Bool",
        doc: "Turn a runtime feature flag on.",
        examples: &[
            (r#"feature_enable("example_flag")"#, r#"true"#),
            (r#""example_flag" | feature_enable()"#, r#"true"#),
        ],
    },
    Signature {
        ...
        params: &[],
        returns: "Bool",
        doc: "Turn a runtime feature flag off, reporting whether it was on.",
        examples: &[
            (r#"feature_disable("never_enabled_flag")"#, r#"false"#),
        ],
    },
    Signature {
        name: "env_unset",
        ...
        aliases: &[],
        subject: None,
        params: &[req("name", Ty::Str, "environment variable to remove")],
        returns: "Bool",
        doc: "Remove a variable from this shell's environment.",
        examples: &[
            (r#"env_unset("AE_EXAMPLE_UNSET_VARIABLE")"#, r#"true"#),
        ],
    },
    Signature {
        name: "env_activate",
        ...
        aliases: &[],
        subject: None,
        params: &[req("path", Ty::Str, "a Python virtualenv directory")],
        returns: "String",
        doc: "The shell command that activates a virtualenv. It returns the command; it does not run it.",
        examples: &[
            (r#"typeof(env_activate(".venv"))"#, r#"String"#),
        ],
    },
    Signature {
        name: "help",
        ...
        params: &[],
        returns: "String",
        doc: "A short reference of the core builtins.",
        examples: &[
            (r#"typeof(help())"#, r#"String"#),
        ],
    },
    Signature {
        ...
        params: &[],
        returns: "String",
        doc: "The platform-specific script for a module: utils becomes utils_linux.ae on Linux, utils_windows.ae on Windows.",
        examples: &[
            (r#"typeof(platform_module("mymodule"))"#, r#"String"#),
        ],
    },
    Signature {
        name: "plugin_info",
        ...
        params: &[],
        returns: "Record",
        doc: "A plugin's metadata. An unknown id is E_NOT_FOUND.",
        examples: &[
            (r#"plugin_info("builtin.json").id"#, r#"builtin.json"#),
        ],
    },
    Signature {
        ...
        aliases: &[],
        subject: None,
        params: &[opt("limit", Ty::Int, "most recent events to return; default 100")],
        returns: "Array",
        doc: "Recorded telemetry events, most recent first.",
        examples: &[
            (r#"typeof(telemetry_events())"#, r#"Array"#),
            (r#"typeof(telemetry_events(5))"#, r#"Array"#),
        ],
    },
    Signature {
        name: "sess_close",
        ...
        aliases: &[],
        subject: None,
        params: &[req("id", Ty::Str, "a session id")],
        returns: "Record",
        doc: "Discard a session and its environment, reporting whether it existed.",
        examples: &[
            (r#"sess_close("no-such-session").closed"#, r#"false"#),
        ],
    },
    // 1b: agent protocols (a2a, a2ui) and RL/RLM/evolution configuration.
    // `rlm_stats` waits: with no argument it returns constants presented as
    // statistics, and an example script depends on that; it needs a real
    // source of run statistics first.
    Signature {
        name: "a2a_broadcast",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: None,
        params: &[req("message", Ty::Any, "the message every registered agent receives")],
        returns: "Record",
        doc: "Queue a message for every registered agent.",
        examples: &[
            (r#"typeof(a2a_broadcast("hello"))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "a2a_register",
        ...
        aliases: &[],
        subject: None,
        params: &[req("name", Ty::Str, "agent name"), opt("info", Ty::Record, "capabilities and other metadata")],
        returns: "Record",
        doc: "Register an agent so it can receive messages.",
        examples: &[
            (r#"typeof(a2a_register("example-agent"))"#, r#"Record"#),
            (r#"typeof(a2a_register("example-agent", {role: "demo"}))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "a2a_receive",
        ...
        aliases: &[],
        subject: None,
        params: &[opt("agent", Ty::Str, "whose messages; default \"default\"")],
        returns: "Array",
        doc: "Take an agent's pending messages, emptying its queue.",
        examples: &[
            (r#"a2a_receive("agent-nobody-registered")"#, r#"[]"#),
            (r#"typeof(a2a_receive())"#, r#"Array"#),
        ],
    },
    Signature {
        name: "a2a_unregister",
        ...
        aliases: &[],
        subject: None,
        params: &[req("name", Ty::Str, "agent name")],
        returns: "Record",
        doc: "Remove an agent and its queue, reporting whether it was registered.",
        examples: &[
            (r#"a2a_unregister("no-such-agent").unregistered"#, r#"false"#),
        ],
    },
    Signature {
        name: "a2ui_notify",
        ...
        aliases: &["notify_user"],
        subject: Some(Ty::Any),
        params: &[opt("level", Ty::Any, "info, success, warning or error; a string or {level: ...}")],
        returns: "Record",
        doc: "Send the user a notification. An unknown level is refused, not shown as info.",
        examples: &[
            (r#"a2ui_notify("done").sent"#, r#"true"#),
            (r#"a2ui_notify("done", "success").sent"#, r#"true"#),
        ],
    },
    Signature {
        name: "a2ui_render",
        category: None,
        subject_required: false,
        aliases: &["render_content"],
        subject: Some(Ty::Any),
        params: &[],
        returns: "Bool",
        doc: "Render text, {markdown: ...}, {json: ...} or any value in the UI. Invalid JSON is refused.",
        examples: &[
            (r#"a2ui_render("text")"#, r#"true"#),
        ],
    },
    Signature {
        name: "a2ui_agent_started",
        category: None,
        subject_required: false,
        aliases: &["agent_started"],
        subject: Some(Ty::Any),
        params: &[opt("task", Ty::Any, "what the agent is doing")],
        returns: "Bool",
        doc: "Tell the UI an agent has started.",
        examples: &[
            (r#"a2ui_agent_started("a1")"#, r#"true"#),
            (r#"a2ui_agent_started("a1", "indexing")"#, r#"true"#),
        ],
    },
    Signature {
        name: "a2ui_agent_completed",
        category: None,
        subject_required: false,
        aliases: &["agent_completed"],
        subject: Some(Ty::Any),
        params: &[opt("success", Ty::Bool, "whether it succeeded; default true"), opt("result", Ty::Any, "what it produced")],
        returns: "Bool",
        doc: "Tell the UI an agent has finished.",
        examples: &[
            (r#"a2ui_agent_completed("a1")"#, r#"true"#),
            (r#"a2ui_agent_completed("a1", false, "timed out")"#, r#"true"#),
        ],
    },
    Signature {
        name: "a2ui_status",
        ...
        params: &[],
        returns: "Bool",
        doc: "Set the status-bar text.",
        examples: &[
            (r#"a2ui_status("working")"#, r#"true"#),
        ],
    },
    Signature {
        name: "a2ui_toast",
        ...
        aliases: &["toast"],
        subject: Some(Ty::Any),
        params: &[opt("level", Ty::Str, "info, success, warning or error"), opt("duration_ms", Ty::Numeric, "default 3000")],
        returns: "Bool",
        doc: "Show a transient notification. An unknown level is refused.",
        examples: &[
            (r#"a2ui_toast("saved")"#, r#"true"#),
            (r#"a2ui_toast("saved", "success", 1000)"#, r#"true"#),
        ],
    },
    Signature {
        name: "rl_gridworld",
        ...
        aliases: &[],
        subject: None,
        params: &[opt("width", Ty::Int, "default 5"), opt("height", Ty::Int, "default: the width")],
        returns: "Record",
        doc: "A gridworld environment for reinforcement learning.",
        examples: &[
            (r#"typeof(rl_gridworld())"#, r#"Record"#),
            (r#"typeof(rl_gridworld(3, 4))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "rl_replay_buffer",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: None,
        params: &[opt("capacity", Ty::Int, "default 10000")],
        returns: "Record",
        doc: "An experience replay buffer.",
        examples: &[
            (r#"typeof(rl_replay_buffer())"#, r#"Record"#),
            (r#"typeof(rl_replay_buffer(100))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "rlm_config",
        ...
        aliases: &[],
        subject: None,
        params: &[opt("options", Ty::Record, "max_depth, max_agents, timeout, ...")],
        returns: "Record",
        doc: "A recursive-agent configuration, with defaults for anything not given.",
        examples: &[
            (r#"rlm_config().max_depth"#, r#"5"#),
            (r#"rlm_config({max_depth: 3}).max_depth"#, r#"3"#),
        ],
    },
    Signature {
        ...
        aliases: &[],
        subject: None,
        params: &[opt("options", Ty::Record, "population_size, generations, mutation_rate, ...")],
        returns: "Record",
        doc: "An evolutionary-search configuration, with defaults for anything not given.",
        examples: &[
            (r#"typeof(evolution_config())"#, r#"Record"#),
            (r#"evolution_config({population_size: 10}).population_size"#, r#"10"#),
        ],
    },
    // 1b: hashing, base64 and read-only file inspection. Examples read files
    // in this repository, because that is where the declaration tests run.
    Signature {
        name: "crypto_hash",
        category: None,
        subject_required: false,
        aliases: &["hash"],
        subject: Some(Ty::Str),
        params: &[opt("algorithm", Ty::Str, "md5, sha1, sha256 (default), sha384 or sha512")],
        returns: "String",
        doc: "Hex digest of a string. An unknown algorithm is refused, never substituted.",
        examples: &[
            (r#"crypto_hash("hello")"#, r#"2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824"#),
            (r#"crypto_hash("hello", "md5")"#, r#"5d41402abc4b2a76b9719d911017c592"#),
        ],
    },
    Signature {
        name: "md5",
        ...
        params: &[],
        returns: "String",
        doc: "MD5 hex digest of a string. Refused under AETHER_FIPS.",
        examples: &[
            (r#"md5("hello")"#, r#"5d41402abc4b2a76b9719d911017c592"#),
        ],
    },
    Signature {
        name: "sha256",
        ...
        params: &[],
        returns: "String",
        doc: "SHA-256 hex digest of a string.",
        examples: &[
            (r#"sha256("hello")"#, r#"2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824"#),
        ],
    },
    Signature {
        name: "crypto_hash_file",
        category: None,
        subject_required: false,
        aliases: &[],
        subject: None,
        params: &[req("path", Ty::Str, "a file path"), opt("algorithm", Ty::Str, "md5, sha1, sha256 (default), sha384 or sha512")],
        returns: "String",
        doc: "Hex digest of a file's contents.",
        examples: &[
            (r#"crypto_hash_file("Cargo.toml") | len"#, r#"64"#),
            (r#"crypto_hash_file("Cargo.toml", "md5") | len"#, r#"32"#),
        ],
    },
    Signature {
        ...
        params: &[req("path", Ty::Str, "a file path"), opt("algorithm", Ty::Str, "md5, sha1, sha256 (default), sha384 or sha512")],
        returns: "String",
        doc: "Hex digest of a file's contents; the same as crypto_hash_file.",
        examples: &[
            (r#"crypto_checksum("Cargo.toml") | len"#, r#"64"#),
            (r#"crypto_checksum("Cargo.toml", "sha512") | len"#, r#"128"#),
        ],
    },
    Signature {
        ...
        params: &[],
        returns: "String",
        doc: "Standard base64 of a string, unwrapped.",
        examples: &[
            (r#"base64_encode("hello")"#, r#"aGVsbG8="#),
            (r#""hello" | base64_encode()"#, r#"aGVsbG8="#),
        ],
    },
    Signature {
        ...
        category: None,
        subject_required: false,
        aliases: &["base64_decode"],
        subject: Some(Ty::Str),
        params: &[],
        returns: "String",
        doc: "Decode base64 to text. Whitespace is ignored; invalid base64 or binary output is refused.",
        examples: &[
            (r#"base64_decode("aGVsbG8=")"#, r#"hello"#),
        ],
    },
    Signature {
        name: "file_exists",
        category: None,
        subject_required: false,
        aliases: &["path_exists", "exists"],
        subject: Some(Ty::Str),
        params: &[],
        returns: "Record",
        doc: "Whether a path exists, and whether it is a file or a directory.",
        examples: &[
            (r#"file_exists("Cargo.toml").exists"#, r#"true"#),
            (r#"(file_exists("Cargo.toml")).is_file"#, r#"true"#),
        ],
    },
    Signature {
        name: "file_type",
        ...
        returns: "String",
        doc: "The MIME type a path's extension indicates.",
        examples: &[
            (r#"file_type("data.json")"#, r#"application/json"#),
        ],
    },
    Signature {
        name: "fs_lstat",
        ...
        params: &[req("path", Ty::Str, "a file path")],
        returns: "Record",
        doc: "Size and kind of a path, without following a symlink.",
        examples: &[
            (r#"typeof(fs_lstat("Cargo.toml"))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "fs_realpath",
        ...
        params: &[req("path", Ty::Str, "a file path")],
        returns: "String",
        doc: "The canonical absolute path, with symlinks resolved.",
        examples: &[
            (r#"ends_with(fs_realpath("Cargo.toml"), "Cargo.toml")"#, r#"true"#),
        ],
    },
    Signature {
        name: "fs_glob",
    ...
    Signature {
        ...
        params: &[req("path", Ty::Str, "a file path")],
        returns: "Record",
        doc: "File metadata: size, times, and on Unix mode, inode and ownership.",
        examples: &[
            (r#"typeof(fs_stat("Cargo.toml"))"#, r#"Record"#),
        ],
    },
    Signature {
        name: "read_text",
        ...
        params: &[req("path", Ty::Str, "a file path")],
        returns: "String",
        doc: "A text file's contents, subject to the read denylist and size limit.",
        examples: &[
            (r#"(read_text("Cargo.toml") | len) > 0"#, r#"true"#),
        ],
    },
    Signature {
        name: "fs_du",
        ...
        aliases: &["du"],
        subject: None,
        params: &[opt("path", Ty::Str, "directory; default the current one")],
        returns: "Record",
        doc: "Total size of a directory tree, in bytes and larger units.",
        examples: &[
            (r#"typeof(du())"#, r#"Record"#),
